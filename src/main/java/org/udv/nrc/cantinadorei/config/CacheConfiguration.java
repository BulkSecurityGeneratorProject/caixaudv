package org.udv.nrc.cantinadorei.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(org.udv.nrc.cantinadorei.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(org.udv.nrc.cantinadorei.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
