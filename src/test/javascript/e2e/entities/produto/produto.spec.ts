...
describe('Produto e2e test', () => {
    ...
    it('should load Produtos', async () => {
        ...
        expect(await produtoComponentsPage.getTitle()).to.eq('cantinadoreiApp.produto.home.title');
    });
    ...
    it('should load create Produto page', async () => {
        ...
        expect(await produtoUpdatePage.getPageTitle()).to.eq('cantinadoreiApp.produto.home.createOrEditLabel');
    ...
    it('should delete last Produto', async () => {
        ...
        expect(await produtoDeleteDialog.getDialogTitle()).to.eq('cantinadoreiApp.produto.delete.question');
