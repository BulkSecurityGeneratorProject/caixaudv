...
describe('Conta e2e test', () => {
    ...
    it('should load Contas', async () => {
        ...
        expect(await contaComponentsPage.getTitle()).to.eq('cantinadoreiApp.conta.home.title');
    });

    it('should load create Conta page', async () => {
        await contaComponentsPage.clickOnCreateButton();
        contaUpdatePage = new ContaUpdatePage();
        expect(await contaUpdatePage.getPageTitle()).to.eq('cantinadoreiApp.conta.home.createOrEditLabel');
    ...
    it('should delete last Conta', async () => {
        ...
        expect(await contaDeleteDialog.getDialogTitle()).to.eq('cantinadoreiApp.conta.delete.question');
