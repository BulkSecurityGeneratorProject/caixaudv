...
export class ContaUpdatePage {
    ...
    nivelPermissaoSelect = element(by.id('field_nivelPermissao'));
    ...
    async setNivelPermissaoSelect(nivelPermissao) {
        await this.nivelPermissaoSelect.sendKeys(nivelPermissao);
    }

    async getNivelPermissaoSelect() {
        return this.nivelPermissaoSelect.element(by.css('option:checked')).getText();
    }

    async nivelPermissaoSelectLastOption() {
        await this.nivelPermissaoSelect
