...
describe('SessaoCaixa e2e test', () => {
    ...
    it('should load SessaoCaixas', async () => {
        ...
        expect(await sessaoCaixaComponentsPage.getTitle()).to.eq('caixaudvApp.sessaoCaixa.home.title');
    });
    ...
    it('should load create SessaoCaixa page', async () => {
        ...
        expect(await sessaoCaixaUpdatePage.getPageTitle()).to.eq('caixaudvApp.sessaoCaixa.home.createOrEditLabel');
    ...
    it('should delete last SessaoCaixa', async () => {
        ...
        expect(await sessaoCaixaDeleteDialog.getDialogTitle()).to.eq('caixaudvApp.sessaoCaixa.delete.question');
