...
describe('Ressarcimento e2e test', () => {
    ...
    it('should load Ressarcimentos', async () => {
        ...
        expect(await ressarcimentoComponentsPage.getTitle()).to.eq('caixaudvApp.ressarcimento.home.title');
    });
    ...
    it('should load create Ressarcimento page', async () => {
        ...
        expect(await ressarcimentoUpdatePage.getPageTitle()).to.eq('caixaudvApp.ressarcimento.home.createOrEditLabel');
    ...
    it('should delete last Ressarcimento', async () => {
        ...
        expect(await ressarcimentoDeleteDialog.getDialogTitle()).to.eq('caixaudvApp.ressarcimento.delete.question');
