...
describe('ItemCompra e2e test', () => {
    ...
    it('should load ItemCompras', async () => {
        ...
        expect(await itemCompraComponentsPage.getTitle()).to.eq('cantinadoreiApp.itemCompra.home.title');
    });
    ...
    it('should load create ItemCompra page', async () => {
        ...
        expect(await itemCompraUpdatePage.getPageTitle()).to.eq('cantinadoreiApp.itemCompra.home.createOrEditLabel');
    ...
    it('should delete last ItemCompra', async () => {
        ...
        expect(await itemCompraDeleteDialog.getDialogTitle()).to.eq('cantinadoreiApp.itemCompra.delete.question');
