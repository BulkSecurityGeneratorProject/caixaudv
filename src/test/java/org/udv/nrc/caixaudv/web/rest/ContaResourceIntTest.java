...
public class ContaResourceIntTest {
    ...
    public static Conta createEntity(EntityManager em) {
        Conta conta = new Conta()
            ...
            .nivelPermissao(DEFAULT_NIVEL_PERMISSAO);
        return conta;
    }
    ...
    public void createConta() throws Exception {
        ...
        assertThat(testConta.getNivelPermissao()).isEqualTo(DEFAULT_NIVEL_PERMISSAO);
    }
    ...
    @Test
    @Transactional
    public void checkNivelPermissaoIsRequired() throws Exception {
        int databaseSizeBeforeTest = contaRepository.findAll().size();
        // set the field null
        conta.setNivelPermissao(null);
    ...
    public void getAllContas() throws Exception {
        ...
        restContaMockMvc.perform(get("/api/contas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nivelPermissao").value(hasItem(DEFAULT_NIVEL_PERMISSAO.toString())));
    }
    ...
    public void getConta() throws Exception {
        ...
        restContaMockMvc.perform(get("/api/contas/{id}", conta.getId()))
            ...
            .andExpect(jsonPath("$.nivelPermissao").value(DEFAULT_NIVEL_PERMISSAO.toString()));
    }
    ...
    public void updateConta() throws Exception {
        ...
        updatedConta
            ...
            .nivelPermissao(UPDATED_NIVEL_PERMISSAO);
        ...
        assertThat(testConta.getNivelPermissao()).isEqualTo(UPDATED_NIVEL_PERMISSAO);
    }
